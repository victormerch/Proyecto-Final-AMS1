			...
			if (player1.getUsername() == "CPU") {
				...
				if (player1.getAgil() * 10 > atackPlayer1) {
					if (player2.getAgil() < dodgePlayer2) {
						...
						System.out.println(player1.getUsername() + "-> Successful attack: -" + player1.getAtack());
						System.out
				...
				if (player2.getLife() > 0) {
					...
					if (player2.getAgil() * 10 > atackPlayer2) {
						if (player1.getAgil() < dodgePlayer1) {
							...
							System.out.println(player2.getUsername() + "-> Successful attack: -" + player2.getAtack());
							System.out.println(
		...
		if (fightfinal){
			...
			if (player1.getUsername() == "CPU") {
				if (player1.getLife() > player2.getLife()) {
					...
					int confirmado = JOptionPane.showConfirmDialog(null,
							"GAMEOVER\nDo you want to play with a different character again?\n" + "You've got: "
									+ totalPoints + " points","Round result", JOptionPane.YES_NO_OPTION);
				...
				// When you win:
					...
					int confirmado = JOptionPane.showConfirmDialog(null,
							"You have won, do you want to play another round?","Round result", JOptionPane.YES_NO_OPTION);
					if (JOptionPane.OK_OPTION == confirmado) {
