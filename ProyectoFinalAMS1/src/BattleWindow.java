...
public class BattleWindow extends JPanel{
	...
	public BattleWindow(Warrior warriorPlayer,Weapon weaponPlayer) {
		
		setLayout(new BorderLayout());
		JPanel panel1 = new JPanel();
		panel1.add(new JButton("Choose Warrior"));
		panel1.add(new JButton("Choose Weapon"));
		panel1.add(new JButton("Ranking"));
		add(panel1,BorderLayout.NORTH);
		
		add(new WarriorPanel(warriorPlayer.getImg(),weaponPlayer.getWeapon_url()),BorderLayout.EAST);
		...
		add(new WarriorPanel(warriorPlayer.getImg(),weaponPlayer.getWeapon_url()),BorderLayout.WEST);
...
class WarriorPanel extends JPanel{
	public WarriorPanel(String imgURL,String imgURL2) {
		...
		Toolkit mipantalla = Toolkit.getDefaultToolkit();
		Image miicono = mipantalla.getImage(sCarpAct+File.separator+"imagenes"+File.separator+imgURL);
		...
		Image miicono2 = mipantalla2.getImage(sCarpAct+File.separator+"imagenes"+File.separator+imgURL2);
