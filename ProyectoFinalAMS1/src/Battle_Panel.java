...
public class Battle_Panel extends JPanel {
	...
	public Battle_Panel(String username, Warrior warriorPlayer, Weapon weaponPlayer, Warrior warriorCPU,
		...
		JLabel text2 = new JLabel("Record Points:", JLabel.LEFT);
		...
		Image miicono = mipantalla
				.getImage(sCarpAct + File.separator + "img" + File.separator + "versus.png");
...
class WarriorPanel extends JPanel {
	...
	public WarriorPanel(Color colorUser, String namePlayer, Warrior warriorPlayer, Weapon weaponPlayer) {
		...
		panelImg.setToolTipText("<html><body style=\"background-color:black;\"><p color=white>HP: "
				+ warriorPlayer.getHealth() + "<br>Damage: " + warriorPlayer.getForce() + "<br>Defense: "
				+ warriorPlayer.getDefense() + "<br>Agility: " + warriorPlayer.getAgility() + "<br>Speed: "
				+ warriorPlayer.getVelocity() + "</p></body></hmtl>");
		...
		panelStats.add(img2);
		img2.setToolTipText(
				"<html><body style=\"background-color:white;\"><p color=black>Speed: " + weaponPlayer.getPlus_velocity()
						+ "<br>Damage: " + weaponPlayer.getPlus_force() + "</p></body></html>");
		...
		panelGrid.setToolTipText("<html><body style=\"background-color:black;\"><p color=red>Power: "
				+ (warriorPlayer.getForce() + weaponPlayer.getPlus_force()) + "<br> Defense: "
				+ warriorPlayer.getDefense() + "<br> Agility: " + warriorPlayer.getAgility() + "<br> Speed: "
				+ (warriorPlayer.getVelocity() + weaponPlayer.getPlus_velocity()) + "</p></body></html>");
