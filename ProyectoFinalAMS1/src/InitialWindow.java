...
//Panel que coge la informacio de la base de datos y el username
public class InitialWindow extends JPanel{
	...
	public InitialWindow() {
		...
		Image miicono = mipantalla.getImage("icon2.png");

		Image dimg = miicono.getScaledInstance(300, 180,
		        Image.SCALE_SMOOTH);
		...
		username = new JTextField("pepe",10);
